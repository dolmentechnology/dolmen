...
Only requiring some minor changes is dolmen.cpp.
...
Changes to dolmen.cpp
----------------------
dolmen.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
