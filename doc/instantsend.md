...
This mechanism has been integrated into Bitcore-Node-Dolmen which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dolmenpay/insight-api-dolmen#web-socket-api](https://github.com/dolmenpay/insight-api-dolmen#web-socket-api)
* API: [https://github.com/dolmenpay/insight-api-dolmen#instantsend-transactions](https://github.com/dolmenpay/insight-api-dolmen#instantsend-transactions)
...
By default, the Dolmen Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dolmen Core daemon:
