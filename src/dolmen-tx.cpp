...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Dolmen Core dolmen-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dolmen-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dolmen transaction") + "\n" +
              "  dolmen-tx [options] -create [commands]   " + _("Create hex-encoded dolmen transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dolmen transaction
