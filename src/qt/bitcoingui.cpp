    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Dolmen Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dolmen address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dolmen: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Dolmen Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dolmen Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dolmen Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dolmen addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dolmen addresses"));
    ...
    openAction->setStatusTip(tr("Open a dolmen: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dolmen Core help message to get a list with possible Dolmen Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dolmen Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dolmen network", "", count));
    } else {
...
{
    QString strTitle = tr("Dolmen Core"); // default title
