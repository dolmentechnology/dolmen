    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DMN-light"), QVariant("light"));
    ui->theme->addItem(QString("DMN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("DMN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DMN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DMN-traditional"), QVariant("trad"));
