...
#define BOOST_TEST_MODULE Dolmen Test Suite

#include "test_dolmen.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_dolmen_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
