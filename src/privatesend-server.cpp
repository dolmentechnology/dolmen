...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Dolmen related functionality
...
/*
    ...
    allow endless transaction that would bloat Dolmen and make it unusable. To
