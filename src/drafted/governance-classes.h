 ...
 *
 *   // network
 *   CDolmenNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.dolmen.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDolmenNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: DolmenNetwork
// //   -- signature requirements : Key1(User)
// class CDolmenNetworkVariable : public CGovernanceObject
// {
// private:
