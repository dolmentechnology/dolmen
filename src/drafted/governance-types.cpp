...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DolmenNetwork") type = DolmenNetwork;
    if(strType == "DolmenNetworkVariable") type = DolmenNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DolmenNetwork) s = "DolmenNetwork";
    if(type == DolmenNetworkVariable) s = "DolmenNetworkVariable";
